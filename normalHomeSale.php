...
<body>
			...
			<div class="row">
				<div class="col-12">
					<div class="site-navbar">
						<a href="#" class="site-logo"><img src="images/logo.png" width ="100px"alt=""></a>
	...
	<!-- Hero section -->
	<section class="hero-section set-bg" data-setbg="images/7.jpg">
						...
						while($x=mysqli_fetch_array($r, MYSQLI_ASSOC))
						{
							...
							<div class='col-md-4' style="height:300px;">
								...
								<div class='sale-notic'>FOR Sale</div>
									...
									<button class='price' type='submit'><?php echo "Shs. ".$x['totalcost'] ?></button>
									</div>
									</form>
							</div>
				<?php
						...
						while($y=mysqli_fetch_array($r1, MYSQLI_ASSOC))
						{
							...
							<div class='col-md-4' style="height:300px;">
								...
								<div class='sale-notic'>FOR Sale</div>
									...
									<button class='price' type='submit'><?php echo "Shs. ".$y['totalcost'] ?></button>
									</div>
